...
students across eight universities in eight countries. This dataset is a
rich and valuable research resource that can be used to address research
...
useful feedback on your research. We welcome contributions from
researchers from *diverse backgrounds and geographical provenances*. In
...
**Dataset paper**
[https://dl.acm.org/doi/10.1145/3712289](https://dl.acm.org/doi/10.1145/3712289)

**Data catalog**
[{{< var link.catalog >}}]({{< var link.catalog >}})

**Dataset webpage**
[https://datascientia.eu/projects/diversityone/](https://datascientia.eu/projects/diversityone/)

**Conference webpage UbiComp / ISWC 2025**
[https://www.ubicomp.org/ubicomp-iswc-2025/](https://www.ubicomp.org/ubicomp-iswc-2025/)
...
European General Data Protection Regulation (GDPR). The dataset contains
questionnaire answers from over 18K students, 782 of whom agreed to
...
daily reports on sleep quality and daily expectations. The combination
of sensor data and self-reported data across eight universities
...
describing potential societal impact. The paper should follow the
[UbiComp/ISWC template and guideline](https://www.ubicomp.org/ubicomp-iswc-2025/authors/formatting/).
...
## Special track in Journal

A selection of the accepted papers will be invited to submit an extended
version to a special track in a journal related to the topics of the
workshop (details will be released in the next few weeks).

## How to get the datasets

1.  **Navigate the data catalog.** The catalog is available at
    ...
    contains both basic datasets (e.g., one sensor) and bundles of basic
    sensors (e.g., motion sensors such as accelerometer and step
    counter) split by data collection location. Any composition of
    bundle, datasets and data collection location can be requested
    coherently with your research proposal.
...
the use of social media [@giunchiglia2018mobile], the quality of answers and mislabeling
[@bontempelli2020learning], the usefulness of self-reports towards understanding the user's
subjective perspective of the local context [@zhang2021putting], the impact of COVID
on the students' lives [@girardini2023adaptation], cross-individual activity recognition
[@shen2022federated], mood inference [@meegahapola2023generalization], diversity perceptions in a community
[@kun2022], activity recognition [@bouton2022your], social context inference while eating
[@kammoun2023understanding], inferring mood-while-eating [@bangamuarachchi2023inferring], and the generation of
contextually rich data with other reference datasets [@giunchiglia2024big].
